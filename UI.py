...
def setup_ui(win):
    ...
    mighty.grid_rowconfigure(6, weight=1)
    ...
    expiry_label.grid(column=0, row=2, sticky='W', padx=5, pady=5)
    expiry_date = tk.StringVar()
    expiry_entered = ttk.Entry(mighty, width=20, textvariable=expiry_date)
    expiry_entered.grid(column=1, row=2, sticky='W', padx=5, pady=5)
